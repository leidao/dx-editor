 ...
 * @LastEditors: ldx
 * @LastEditTime: 2024-10-31 09:20:41
 */

import { IEventListenerId, IPointerEvent, Matrix3, OrbitEvent, Text } from "@/dxCanvas"
...
export default class TextEditInner extends EditTool {
  ...
  onUpdate = () => {
    ...
    // const { textBaseline } = text.style
    style.transform = `matrix(${a},${b},${c},${d},${e},${f - ((height + 3) * d) / 2})`
